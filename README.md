...
Update the ipv6 range in `squid.conf` to the /64 subnet of your interface. Update the ipv6 prefix in `rpipv6.sh` to match. Run setup.sh or apply the following manually:
